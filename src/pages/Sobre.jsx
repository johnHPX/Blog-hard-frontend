    ...
    <main className="sobre">
      ...
      <section className="sobre-autor">
        ...
        <p>
          ...
          técnico em informática. Tenho interesse por <em>desenvolvimento web, mobile, jogos
          e ciência da computação</em>.
        </p>
        <p>
      ...
      <section className="sobre-missao">
        <h2>Missão</h2>
        <p>
          Registrar minha evolução como desenvolvedor e incentivar a troca 
          de ideias do mundo da tecnologia.
        </p>
      </section>
    </main>
  );
